...
*      USE DFLIB
	...
	SAVE
      ...
      DOUBLE PRECISION LAI, SWFAC1, SWFAC2
      DOUBLE PRECISION SRAD, TMAX, TMIN, PAR, RAIN
...
************************************************************************
      ...
      SUBROUTINE TESTET(var1, answer) 

      double precision var1(*), answer

      answer = var1(1)

      OPEN (125,FILE='teste.out',STATUS='REPLACE')
      write(125,*) VAR1(1)
      write(125,*) VAR1(2)
      write(125,*) VAR1(3)
      write(125,*) VAR1(4)
