...
!-----------------------------------------------------------------------
	...
	SAVE
      ...
      INTEGER   DATE, DOY
      DOUBLE PRECISION SRAD,TMAX,TMIN,RAIN,SWC,INF,IRR,ROF,ESa,EPa,DRNp
      DOUBLE PRECISION DRN,DP,WPp,FCp,STp,WP,FC,ST,ESp,EPp,ETp,LAI
      CHARACTER*10 DYN

      DOUBLE PRECISION CN, SWFAC1, SWFAC2, POTINF 
      DOUBLE PRECISION SWC_INIT, TRAIN, TIRR, TESA, TEPA, TROF, TDRN
      DOUBLE PRECISION TINF, SWC_ADJ
...
!-----------------------------------------------------------------------
	...
	SAVE
      ...
      DOUBLE PRECISION SWC, FC, DRN, DRNp
!-----------------------------------------------------------------------
...
!-----------------------------------------------------------------------
	...
	SAVE
      ...
      DOUBLE PRECISION a, SWC, WP, FC, ESa, ESp
!-----------------------------------------------------------------------
      IF (SWC .LT. WP) THEN
        a = 0
...
!-----------------------------------------------------------------------
      ...
      DOUBLE PRECISION    ALB,EEQ,f,Tmed,LAI
      DOUBLE PRECISION TMAX, TMIN, SRAD, ETP  
...
!-----------------------------------------------------------------------
	...
	SAVE
      ...
      CHARACTER*10 DYN
      DOUBLE PRECISION S, CN
      DOUBLE PRECISION POTINF, ROF 
...
!-----------------------------------------------------------------------  
	...
	SAVE
      ...
      CHARACTER*10 DYN
      DOUBLE PRECISION FC, ST, SWC, WP, SWFAC2, SWFAC1
      DOUBLE PRECISION DP, DWT, WTABLE, THE
      DOUBLE PRECISION STRESS_DEPTH
      PARAMETER (STRESS_DEPTH = 250)   !Water table depth below 
...
!-----------------------------------------------------------------------
	...
	SAVE
      ...
      INTEGER LSWC
      PARAMETER (LSWC = 21)
      DOUBLE PRECISION SWC, SWC_INIT
      DOUBLE PRECISION TDRN, TEPA, TESA, TIRR, TRAIN, TROF
      DOUBLE PRECISION WATBAL, SWC_ADJ, TINF
