...
!-----------------------------------------------------------------------  
      ...
      DOUBLE PRECISION E,Fc,Lai, nb,N,PT,Pg, di,PAR
      DOUBLE PRECISION rm,dwf,int, TMAX,TMIN, p1, sla
      DOUBLE PRECISION PD,EMP1,EMP2,Lfmax,dwc, TMN
      DOUBLE PRECISION dwr,dw,dn,w,wc,wr,wf,tb,INTOT, dLAI, FL
      INTEGER DOY, endsim, COUNT
      CHARACTER*10 DYN

      DOUBLE PRECISION SWFAC1, SWFAC2  
...
!-----------------------------------------------------------------------  
      IMPLICIT NONE
      DOUBLE PRECISION PD,EMP1,EMP2,N,nb,dLAI, SWFAC,a, dN, p1,sla
      DOUBLE PRECISION SWFAC1, SWFAC2, PT, di, FL
!-----------------------------------------------------------------------  
...
!-----------------------------------------------------------------------  
      ...
      DOUBLE PRECISION PAR, Lai, Pg, PT, Y1
      DOUBLE PRECISION SWFAC1, SWFAC2, SWFAC,ROWSPC,PD
